...
budgetlist_router = routers.NestedSimpleRouter(router, r'budgetlists', lookup='budgetlist')
budgetlist_router.register("budgets", views.BudgetViewSet, basename="budget")

budget_router = routers.NestedSimpleRouter(budgetlist_router, r'budgets', lookup='budget')
...
urlpatterns = [
    ...
    path("budgetlists/<int:pk>/add-participant/", views.BudgetListAddParticipantViewSet.as_view(), name="add_participant")
]
